    ...
    {/* REMAINDER OF THE COPY */}
    {
        phone
            ? <motion.div
              ...
              > 
                <P>Mas primeiro, deixa eu me apresentar. Meu nome é Leiliane.</P>
                ...
                <P bold>mas, SURPREENDENTEMENTE, a Bia encontrou uma solução.</P>
                <P>Quer saber que solução é essa?</P>
                <P>Vou te contar.</P>
                <P>Mas antes...</P>
                
                {/*  */}
                <H1>Uma pergunta íntima...</H1>
                ...
                <P bold fontColor="#d81414" fontSize="2rem" marginBottom="0px" cssStyle="font-style: italic">"</P>
                ...
                {/*  */}
                <H1>Fiquei tão feliz pela Bia que resolvi <Span bold>ABRIR esse SEGREDO</Span></H1>
                ...
                <P>Da uma olhada no que ESSAS MULHERES dizem quando experimentam minha comida:</P>
                ...
                {/*  */}
                <H1>A forma não convencional</H1>
                ...
                <P>Talvez você esteja se perguntando:</P>
                ...
                {/*  */}
                <P fontSize="1.8rem">Aqui estão os planos. Você que escolhe:</P>
                ...
                {/*  */}
                <H1>Nesse momento, o seu risco financeiro é ZERO!</H1>
                ...
                {/*  */}
                <H1 fontColor="#d81414">Mas isso NÃO garante teu acesso</H1>
